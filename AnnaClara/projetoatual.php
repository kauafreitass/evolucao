...
<br>Onde o próprio usuário cadastra seu produto, valorizando a estética e o cuidado pessoal de forma única.</b>
    ...
    <div class="project-item">
        <div class="image-container">
            <img class="project-image" src="img/catalogo1.PNG" alt="Design Responsivo" >
        </div>
        <div class="content-container">
            <h3 class="project-title">Design Catálogado</h3>
            <p class="project-description">
    ...
    <div class="project-item">
        <div class="image-container">
            <img class="project-image" src="img/catalogo2.PNG" alt="Integração de Tecnologias">
        </div>
        <div class="content-container">
            <h3 class="project-title">Beleza e Tecnologia</h3>
            <p class="project-description">
    ...
    <div class="project-item">
        <div class="image-container">
            <img class="project-image" src="img/catalogo5.PNG" alt="Estética Minimalista">
        </div>
        <div class="content-container">
            <h3 class="project-title">Estilo Sofisticado</h3>
            <p class="project-description">
    ...
    <div class="project-item">
        <div class="image-container">
            <img class="project-image" src="img/catalogo3.PNG" alt="Soluções Sustentáveis">
        </div>
        <div class="content-container">
            <h3 class="project-title">Atribuindo Armazenamento de Dados</h3>
            <p class="project-description">
    ...
    <div class="project-item">
        <div class="image-container">
            <img class="project-image" src="img/catalogo6.PNG" alt="Inovação Tecnológica">
        </div>
        <div class="content-container">
            <h3 class="project-title">Meios de Deletar Produto</h3>
            <p class="project-description">
    ...
    <div class="project-item">
        <div class="image-container">
            <img class="project-image" src="img/catalogo4.PNG" alt="Criatividade Contemporânea">
        </div>
        <div class="content-container">
            <h3 class="project-title">Conexão com o Luxo</h3>
            <p class="project-description">
